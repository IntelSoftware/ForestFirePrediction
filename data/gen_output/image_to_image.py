...
if __name__ == "__main__":
    ...
    base_prompt = "A close image to this original satellite image with slight change in location, with no cloud cover, real satellite image"
    fire_variations = [
        "early morning with a wild fire",
        "late afternoon with signs of wild fire",
        "mid-day signs of wild fire",
        "visible wild fire lines",
    ]
    no_fire_variations = [
        "early morning with clear skies no signs of wild fire",
        "no signs of wild fire",
        "late afternoon with clear skies no signs of wild fire",
        "mid-day with clear skies with no signs of wild fire",
        "with dense vegetation no signs of  wild fire",
        "with sparse vegetation no signs of wild fire",
    ]
